        ...
        >
          <div className="flex gap-3 sm:gap-5 lg:gap-8 pb-3 sm:pb-5 lg:pb-8 px-1 sm:px-3 lg:px-4">
            {cards.map((card) => (
              <div 
                key={card.id} 
                className="min-w-[260px] sm:min-w-[400px] lg:min-w-[600px] bg-white rounded-lg sm:rounded-xl lg:rounded-2xl shadow-lg transition-transform hover:scale-[1.02] duration-300"
              >
