...
const BlogDetails = () => {
  ...
  const [headingsExtracted, setHeadingsExtracted] = useState(false);
  ...
  return (
    <div className={styles.smartSyndication}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* Article Section - Updated with Table of Contents */}
        <article className="w-full mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 mt-8 sm:mt-12 lg:mt-16">
          ...
          <div className="relative flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8 p-4 sm:p-6 lg:p-8 max-h-[calc(100vh-80px)] sm:max-h-[calc(100vh-100px)] overflow-hidden w-full max-w-[1920px] mx-auto">
            ...
            <div
              ref={contentRef}
              className="flex-1 overflow-y-auto blog-content relative order-1 lg:order-2 px-0 sm:px-4"
              role="article"
            >
            ...
            <aside className="w-full lg:w-80 flex-shrink-0 order-3 px-0 sm:px-4">
              <div className="sticky top-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-md overflow-hidden border border-gray-100 transition-all duration-200 hover:shadow-lg">
                ...
                <div className="p-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                  {headings.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <p className="text-gray-500 text-sm">No headings found in this article</p>
                      <p className="text-xs text-gray-400 mt-2">This article doesn't have any H1-H6 heading tags</p>
                    </div>
                  )}
                </div>

                {/* Download Button inside Table of Contents */}
                <div className="border-t border-gray-100 p-4 bg-gray-50">
                  <button
                    onClick={handleDownload}
                    className="group flex items-center justify-center w-full gap-2 px-4 py-3 bg-gradient-to-r from-[#FF6B2C] to-[#E65A1F] text-white text-sm font-semibold rounded-lg shadow-md hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B2C] focus-visible:ring-offset-2 active:transform active:scale-95 transition-all duration-200"
                    disabled={isSubmitting}
                  >
                    <svg
                      className="w-4 h-4 text-white transition-transform group-hover:translate-y-0.5"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                      viewBox="0 0 24 24"
                    ...
                    <span>{isSubmitting ? 'Downloading...' : 'Get the Ethical Practices Checklist'}</span>
                  </button>
                </div>
              </div>
            </aside>
