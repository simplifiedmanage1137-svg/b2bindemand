...
import Get_Seen_Get_Heard from "../assets/Get_Seen_Get_Heard.png";
import How_Smart_Syndication from "../assets/How_Smart_Syndication.png";
import Multi_Channel_Content_Distribution from "../assets/Multi_Channel_Content_Distribution.svg";
import Lead_Qualification_Intent_Tracking from "../assets/Lead_Qualification_Intent_Tracking.svg";
import Sales_Ready_Lead_Handoff from "../assets/Sales_Ready_Lead_Handoff.svg";
import Performance_Optimization from "../assets/Performance_Optimization.svg";
import radio_two from "../assets/Icon/radio_two.svg";
import people_search_one from "../assets/Icon/people_search_one.svg";
import pay_code_one from "../assets/Icon/pay_code_one.svg";
import shopping_cart_two from "../assets/Icon/shopping_cart_two.svg";
import scanning_two from "../assets/Icon/scanning_two.svg";
import Content from "../assets/Content.svg";
import From_Content from "../assets/From_Content.svg";
import Track_Adjust_Scale from "../assets/Track_Adjust_Scale.svg";
...
const SmartSyndication = () => {
  const { title, description, keywords, ogImage } = seoConfig.smartSyndication;
  ...
  const workItems = {
    research: {
      image: How_Smart_Syndication,
      title: "ICP Research & Audience Mapping",
      content:
        "We define your perfect-fit prospects, ensuring your content reaches the right industries, job titles, and decision-makers.",
    },
    distribution: {
      image: Multi_Channel_Content_Distribution,
      title: "Multi-Channel Content Distribution",
      content:
        "We strategically distribute your content across multiple channels to maximize reach and engagement.",
    },
    qualification: {
      image: Lead_Qualification_Intent_Tracking,
      title: "Lead Qualification & Intent Tracking",
      content:
        "We qualify leads based on engagement and track intent signals to identify high-potential prospects.",
    },
    handoff: {
      image: Sales_Ready_Lead_Handoff,
      title: "Sales-Ready Lead Handoff",
      content:
        "We deliver qualified leads directly to your sales team, ready for conversion.",
    },
    optimization: {
      image: Performance_Optimization,
      title: "Performance Optimization & Scaling",
      content:
        "We continuously optimize campaigns and scale successful strategies for better results.",
    },
  };
  ...
  const Modal = ({ isOpen, onClose, selectedPdf, onSubmit, formData, formErrors, handleInputChange, isSubmitting, showSuccessMessage }) => {
    if (!isOpen) return null;

    return (
      <div className={styles.modalOverlay} onClick={onClose}>
        <div className={styles.modal} onClick={e => e.stopPropagation()} role="dialog" aria-labelledby="modalTitle">
          <button 
          ...
          <h2 id="modalTitle" className={styles.modalTitle}>Download {selectedPdf?.pdfTitle}</h2>
          {showSuccessMessage ? (
            <div className={styles.successMessage} role="alert">
              Thank you! Your download will begin shortly.
            </div>
          ) : (
            <form onSubmit={onSubmit} className={styles.modalForm} noValidate>
              <div className={styles.formGroup}>
                ...
                {formErrors.firstName && (
                  <span id="firstNameError" className={styles.formError} role="alert">
                    {formErrors.firstName}
                  </span>
                )}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`${styles.formInput} ${formErrors.jobTitle ? styles.inputError : ''}`}
                  placeholder="Enter your job title"
                  required
                  aria-required="true"
                  aria-invalid={!!formErrors.jobTitle}
                  aria-describedby={formErrors.jobTitle ? "jobTitleError" : undefined}
                />
                {formErrors.jobTitle && (
                  <span id="jobTitleError" className={styles.formError} role="alert">
                    {formErrors.jobTitle}
                  </span>
                )}
              </div>
              ...
              <div className={styles.formGroup}>
                <label htmlFor="businessEmail" className={styles.formLabel}>Business Email *</label>
                <input
                  id="businessEmail"
                  type="email"
                  name="businessEmail"
                  ...
                  onChange={handleInputChange}
                  className={`${styles.formInput} ${formErrors.businessEmail ? styles.inputError : ''}`}
                  placeholder="Enter your business email"
                  required
                  aria-required="true"
                  aria-invalid={!!formErrors.businessEmail}
                  aria-describedby={formErrors.businessEmail ? "businessEmailError" : undefined}
                />
                {formErrors.businessEmail && (
                  <span id="businessEmailError" className={styles.formError} role="alert">
                    {formErrors.businessEmail}
                  </span>
                )}
              </div>
  ...
  return (
    <div className={styles.smartSyndication}>
      <Helmet>
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://b2bindemand.com/smart-syndication" />
      </Helmet>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="mt-0 sm:mt-[-1rem] lg:mt-[-2rem] text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-5xl font-bold leading-tight mb-3 sm:mb-4">
              Get Seen. Get Heard. Get
              {/* <br className="hidden sm:block" /> */}
              <span className="text-[#FF6B2C]"> Leads</span>.
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 max-w-2xl lg:max-w-none mx-auto lg:mx-0">
              Get your message in front of the right people, effortlessly.
            </p>
            <Link
              to="/contact-us"
      ...
      >
        <div className={styles.whyContent}>
          <h2 className={styles.whyHeading}>
            Why <span className={styles.highlight}>Smart Syndication</span>
          </h2>
          <p className={styles.whyDescription}>
            Your content isn't just meant to be seen—it should bring in leads
            that matter. We don't just distribute content—we put it where
            high-intent buyers are already looking, keeping your brand top of
            mind when they're ready to take the next step.
          </p>
        </div>
        ...
        <div className={styles.featureCards}>
          ...
          <div className={styles.featureCard}>
            ...
            <h3 className={styles.featureTitle}>From Content to Pipeline</h3>
          </div>
          ...
          <div className={styles.featureCard}>
            ...
            <h3 className={styles.featureTitle}>Track, Adjust, and Scale</h3>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        style={{ maxWidth: "760px", margin: "4rem auto", padding: "0rem" }}
      >
        <h2 className={styles.sectionTitle}>
          What You <span className={styles.highlight}>Get</span> with Smart
          Syndication
        </h2>
        <div className={styles.getFeatures}>
          <div className={styles.getFeatureItem}>
            <div className={styles.getFeatureIcon}>
              <img src={radio_two} alt="Hyper-Targeted Content Distribution" />
            </div>
            <div className={styles.getFeatureText}>
              Hyper-Targeted Content Distribution
            </div>
          </div>
          <div className={styles.getFeatureItem}>
            <div className={styles.getFeatureIcon}>
              <img
                src={people_search_one}
                alt="End-to-End Lead Capture & Qualification"
              />
            </div>
            <div className={styles.getFeatureText}>
              End-to-End Lead Capture & Qualification
            </div>
          </div>
          <div className={styles.getFeatureItem}>
            <div className={styles.getFeatureIcon}>
              <img src={pay_code_one} alt="Multi-Channel Amplification" />
            </div>
            <div className={styles.getFeatureText}>
          ...
          <div className={styles.getFeatureItem}>
            <div className={styles.getFeatureIcon}>
              <img src={shopping_cart_two} alt="Actionable Buyer Insights" />
            </div>
            <div className={styles.getFeatureText}>
          ...
          <div className={styles.getFeatureItem}>
            <div className={styles.getFeatureIcon}>
              <img src={scanning_two} alt="Consistent, High-Quality Pipeline" />
            </div>
            <div className={styles.getFeatureText}>
      ...
      <div className={styles.demandGenSection}>
        <h1 className={styles.demandGenTitle}>
          ...
          <span className={styles.highlight}>Demand Generation Machine</span>
        </h1>
        <p className={styles.demandGenSubtitle}>
          Content alone doesn't drive revenue—
          <span className={styles.subtitleGray}>the right strategy does.</span>
        </p>
...
export default SmartSyndication;
